...
class Calculator:
    ...
    def get_result_of_first_calculation_added_to_history():
        ...
        of first calculation added to history"""
    ...
    @staticmethod
    def history_count():
        """This method counts the history"""
        return len(Calculator.history)
    @staticmethod
    def add_calculation_to_history(calculation):
        """This method will add the calculation to the history"""
        Calculator.history.append(calculation)
        return True
    @staticmethod
    def get_result_of_last_calculation_added_to_history():
        # -1 gets the last item added to the list
        # automaticly and you can expect it to have the get result method
        """This method will give the result
                of last calculation added to history"""
    ...
    def subtract_number(value_a, value_b):
        ...
        # create an subtraction object using
        # the factory we created on the calculation class
    ...
    def multiply_numbers(value_a, value_b):
        ...
        #this is a shorthand way to create
        # the multiplication object and added it the history in one line
    ...
    def divide_numbers(value_a,value_b):
        ...
        # this is a shorthand way to create
        # the division object and added it the history in one line
